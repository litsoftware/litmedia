...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldCompanyID, user.FieldAppID, user.FieldOutUserID:
			values[i] = new(sql.NullInt64)
		case user.FieldName, user.FieldEmail, user.FieldNickname, user.FieldPhone:
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.OutUserID))
